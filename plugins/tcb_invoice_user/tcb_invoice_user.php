<?php
/*
Plugin Name: TCB Plugin
Description: TCB and invoice template functions
Version: 1.0.0
*/
...
//    $fromSource->addToShortcode($tcb_cf7, "fromSource");
    ...
    $radio_source = new tcb_input_radio("fromSource");
    $radio_source->set_option(array("Advertisement", "Designer", "Facebook", "Referral from friends/relatives", "Search Engine", "Walk-in"));
    $radio_source->addToShortcode($tcb_cf7, "fromSource");
