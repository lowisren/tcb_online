<?php
/**
Template Name: Warranty Form Template
 */
get_header();
if ( ! post_password_required() )
{
    ...
    <input type="button" class="show_popup">
    <div class="feedback_popup">
        <?php echo do_shortcode('[contact-form-7 id="3295" title="Feedback form" html_id="feedback_form"]')?>
    </div>
    <script>
        (function($) {
